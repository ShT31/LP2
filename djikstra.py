...
#Enter the places in the college map separated by spaces: A B C D/
#Enter the number of paths between places: 6
#Enter the paths (source, destination, distance):
#A B 2
#A C 4
#B C 1
#B D 7
#C D 3
#D A 5
#Enter the name of the source vertex: A